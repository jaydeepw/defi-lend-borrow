...
const { lendingPoolProviderAbi, lendingPoolAbi } = require('./abis')
...
app.get("/", (req, res) => {
    web3.eth.getBalance(address, async (err, wei) => {
        ...
        const providerInstance = new web3.eth.Contract(lendingPoolProviderAbi, KOVAN_LENDING_POOL_PROVIDER_ADDRESS)
